                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="text-center mb-6">
                            <h2 className="text-3xl font-black text-white mb-3 tracking-tighter uppercase italic">{message.title}</h2>
                            <p className="text-gray-400 mb-4 font-bold">{message.description}</p>
                            <div className="inline-block px-4 py-2 bg-primary/10 rounded-lg border border-primary/20">
                                <span className="text-xs text-primary font-black uppercase tracking-widest">✓ {message.benefit}</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4 mb-6">
                            <input
                                ...
                                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:border-primary outline-none transition font-bold"
                            />
                            <button
                                onClick={() => {
                                    onRegister?.();
                                ...
                                className="w-full py-4 bg-primary text-white rounded-xl font-black hover:opacity-90 transition shadow-lg shadow-primary/20 uppercase tracking-widest text-sm"
                            >
                                Continuar Gratis
                            </button>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    ...
                                    className="py-3 bg-white/10 text-white rounded-lg font-medium hover:bg-white/20 transition border border-white/20 flex items-center justify-center gap-2"
                                >
