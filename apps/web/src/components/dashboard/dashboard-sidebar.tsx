    ...
    return (
        <>
            ...
            <button
                ...
                className="lg:hidden fixed top-6 left-6 z-[60] p-3 bg-[#111116] border border-white/5 rounded-2xl text-white shadow-xl"
            >
            ...
            <aside
                className={cn(
                    "fixed lg:sticky top-0 left-0 h-screen bg-[#0B0B0F]/90 border-r border-white/5 transition-all duration-500 z-[70] flex flex-col overflow-hidden backdrop-blur-3xl shrink-0",
                    collapsed ? "w-24" : "w-72",
            ...
            >
                    ...
                    <Link href="/" className="flex items-center gap-3 group">
                        ...
                        {!collapsed && (
                            <motion.span
                                ...
                                className="text-xl font-bold text-white tracking-tighter uppercase italic"
                            >
                            ...
                            <Link
                                ...
                                className={cn(
                                    ...
                                    isActive
                                        ...
                                        : "text-white/40 hover:text-[#C9A78A] hover:bg-[#C9A78A]/5"
                                )}
                            >
                ...
                {/* Footer Operations */}
                <div className="p-6 border-t border-white/5 bg-white/[0.02] space-y-3 shrink-0">
                    <button
                        onClick={() => logout?.()}
                        className="w-full flex items-center gap-4 px-5 py-4 rounded-[20px] text-white/40 hover:text-red-500 hover:bg-red-500/5 transition-all group font-bold text-sm"
                    >
                    ...
                    <button
                        ...
                        className="hidden lg:flex w-full items-center gap-4 px-5 py-3 hover:bg-white/5 rounded-[18px] text-white/30 hover:text-white transition-all group"
                        title={collapsed ? "Expandir" : "Contraer"}
                    >
                        {collapsed ? <ChevronRight className="w-5 h-5 shrink-0" /> : <ChevronLeft className="w-5 h-5 shrink-0" />}
                        {!collapsed && <span className="text-[10px] font-bold uppercase tracking-[0.2em] opacity-40 italic">Contraer</span>}
                    </button>
                </div>
            </aside>
        </>
