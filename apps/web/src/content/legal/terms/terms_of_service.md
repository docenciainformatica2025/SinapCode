...
Al acceder a la plataforma SinapCode, el Usuario acepta quedar vinculado por estos Términos. Si el Usuario accede desde la Unión Europea (UE) o el Espacio Económico Europeo (EEE), se aplicarán derechos adicionales específicos detallados en la Sección 10 (Privacidad y GDPR).
...
El Usuario acepta que los patrones de interacción anonimizados (no el código privado ni datos personales) podrán ser utilizados para reentrenar y mejorar los modelos pedagógicos de la IA, salvo que ejerza su derecho de oposición (Opt-out) según la sección de privacidad.
